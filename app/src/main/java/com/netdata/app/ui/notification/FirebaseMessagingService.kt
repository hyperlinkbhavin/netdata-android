package com.netdata.app.ui.notification
...
import com.netdata.app.core.AppSession
import com.netdata.app.data.pojo.response.Notification
import com.netdata.app.data.pojo.response.NotificationList
...
//        val defaultSoundUri: Uri = Uri.parse(Constant.notificationPriorityList[1].soundUrl!!)
    ...
    private fun getRemoteView(title: String, message: String): RemoteViews {
        ...
        val remoteView = RemoteViews("com.netdata.app", R.layout.push_notification)
