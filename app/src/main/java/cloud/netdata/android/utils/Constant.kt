...
//    var notificationPriorityList = ArrayList<NotificationPriorityList>()
    ...
    const val APP_PREF_IS_SPACE_SILENCE = "APP_PREF_IS_SPACE_SILENCE"
    ...
    const val APP_PREF_IS_ALL_BUTTON_SELECTED = "APP_PREF_IS_ALL_BUTTON_SELECTED"
    const val APP_PREF_IS_SET_ALERT_FOR_WEBVIEW = "APP_PREF_IS_SET_ALERT_FOR_WEBVIEW"
    const val APP_PREF_IS_SET_ALERT_FOR_BROWSER = "APP_PREF_IS_SET_ALERT_FOR_BROWSER"
    const val APP_PREF_IS_SET_MESSAGE = "APP_PREF_IS_SET_MESSAGE"
    const val APP_PREF_IS_FIRST_LOGIN = "APP_PREF_IS_FIRST_LOGIN"
